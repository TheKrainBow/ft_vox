...
void main()
{
    ...
    int x = (instanceData >> 0) & 0x3F;   // 5 bits for x (0-63)
    int y = (instanceData >> 6) & 0x3F;   // 5 bits for y (0-63)
    int z = (instanceData >> 12) & 0x3F;  // 5 bits for z (0-63)
    int direction = (instanceData >> 18) & 0x07;  // 3 bits for direction
    int textureID = (instanceData >> 21) & 0x7F;  // 7 bits for textureID
